...
declare const AvatarImages: _stitches_react_types_styled_component.StyledComponent<react.ForwardRefExoticComponent<Avatar$1.AvatarImageProps & react.RefAttributes<HTMLImageElement>>, {}, {}, _stitches_react_types_css_util.CSS<{}, {
    colors: {
        white: string;
        black: string;
        gray100: string;
...
interface AvatarProps extends ComponentProps<typeof AvatarImages> {
}
...
declare const TextArea: _stitches_react_types_styled_component.StyledComponent<"div", {}, {}, _stitches_react_types_css_util.CSS<{}, {
    colors: {
        white: string;
        black: string;
        gray100: string;
...
interface CheckBoxContainerPros extends ComponentProps<typeof CheckBoxContainer> {
}
declare function CheckBox(props: CheckBoxContainerPros): react_jsx_runtime.JSX.Element;

interface MultiStepContainerProps {
    size: number;
    currentStep?: number;
}
declare function MultiStep({ size, currentStep }: MultiStepContainerProps): react_jsx_runtime.JSX.Element;

export { Avatar, AvatarProps, Box, BoxProps, Button, ButtonProps, CheckBox, CheckBoxContainerPros, Heading, HeadingProps, MultiStep, MultiStepContainerProps, Text, TextArea, TextAreaProps, TextInput, TextInputProps, TextProps };
